    ...
    >
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        ...
        <div className="flex justify-center reveal">
          <div className="relative w-[260px] p-3 rounded-[40px] bg-[#1a0d0f] shadow-[0_40px_80px_rgba(61,42,45,0.25)]">
            ...
            <div className="relative rounded-[30px] overflow-hidden aspect-[9/19] bg-[var(--cream)]">
              ...
              {/* grid */}
              <svg
                className="absolute bottom-[100px] w-full opacity-20"
                viewBox="0 0 260 80"
              >
              ...
              <div className="absolute bottom-[60px] left-1/2 -translate-x-1/2 animate-ar-float">
                <svg width="100" height="90" viewBox="0 0 140 130">
                  ...
                  <path d="M25 40 Q20 80 24 98 Q50 112 70 112 Q90 112 116 98 Q120 80 115 40 Q102 27 70 26 Q38 27 25 40Z" fill="url(#arBag)"/>
                  <path d="M48 26 Q55 5 70 3 Q85 5 92 26" stroke="#9B5C63" strokeWidth="5" fill="none" strokeLinecap="round"/>
                </svg>
              </div>

              {/* UI TOP */}
              <div className="absolute top-4 left-4 right-4 flex justify-between items-center">
                <span className="px-3 py-1 rounded-full text-[10px] font-semibold tracking-widest text-white"
              ...
              <div className="absolute bottom-0 w-full p-4 bg-gradient-to-t from-[rgba(253,248,245,0.95)] to-transparent">
                ...
                <div className="flex gap-2 mt-2">
                  <button className="flex-1 py-1.5 text-xs rounded-full"
                          style={{
                  ...
                  <button className="flex-1 py-1.5 text-xs rounded-full text-white"
        ...
        <div className="reveal reveal-delay-1">
          ...
          {/* CTA */}
          <button
            className="mt-8 px-8 py-3 rounded-full text-sm text-white transition hover:-translate-y-0.5"
            style={{ background: "var(--rose)" }}
          >
            ✦ Try AR Demo
          </button>
