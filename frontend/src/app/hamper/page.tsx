...
const styles: Record<string, React.CSSProperties> = {
  ...
  card: {
    backgroundColor: "#fff",
    borderRadius: "16px",
    boxShadow: "0 2px 16px rgba(139,26,47,0.06)",
    overflow: "hidden",
    display: "flex",
          ...
          <div style={styles.rightPanel}>
                  ...
                  <div key={item._id} style={styles.itemRow}>
                    ...
                    <div style={styles.itemInfo}>
                      ...
                      <div style={styles.qtyRow}>
                        <button className="zy-qty" style={styles.qtyBtn} onClick={() => changeQty(item._id, -1)}>−</button>
            ...
            {items.length > 0 && (
              <div style={styles.summaryBox}>
                ...
                <button className="zy-co" style={styles.checkoutBtn}>
                  Proceed to Checkout →
                </button>
